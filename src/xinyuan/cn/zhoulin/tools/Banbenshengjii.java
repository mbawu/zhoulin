...
public class Banbenshengjii {
	...
	public Banbenshengjii(String xmlurl, Context cn) {
		this.xmlurl = xmlurl;
		this.cn = cn;
		ha = new Handler() {
			public void handleMessage(Message msg) {
				...
				case 2:
					...
					break;
				case 4:
					Toast.makeText(Banbenshengjii.this.cn, "抱歉网络异常更新失败", 2000)
							.show();
					break;
				case 5:
					Toast.makeText(Banbenshengjii.this.cn, "请检查您的SD卡是否安装", 2000)
							.show();
